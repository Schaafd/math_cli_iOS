...
- Calculator: command input, scientific expressions, autocomplete suggestions, customizable pinned command bar, scrollable Command Drawer, adjustable calculator/scientific input layouts, chained commands, quick operation buttons, session tabs, rename/switch/close behavior.
